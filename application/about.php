...
<div class="container theme-showcase" role="main">
	...
	<div class="col-md-12">
		<div class="panel panel-default">
			...
			<ul class="list-group">
				<li class="list-group-item"><a class="social grey twitter" href="https://www.twitter.com/@GererMaCampagne" target="_blank">@GererMaCampagne</a><span class="badge"><a class="color-inherit" href="https://www.twitter.com/@GererMaCampagne" target="_blank"><span class="glyphicon glyphicon-chevron-right"></span></a></span></li>
	...
	<div class="col-md-12">
		<div class="panel panel-default">
			...
			<ul class="list-group">
				<li class="list-group-item"><a href="releases/GererMaCampagne.1.0.0.tar.gz"
						target="_blank">GererMaCampagne.1.0.0.tar.gz</a><span class="badge"><a class="color-inherit"
						href="releases/GererMaCampagne.1.0.0.tar.gz" target="_blank">c4e211ba2715ebd4a5ffe2607c226808 <span
						class="glyphicon glyphicon-chevron-right"></span></a></span></li>
				<li class="list-group-item"><a href="releases/GererMaCampagne.1.0.0.zip"
						target="_blank">GererMaCampagne.1.0.0.zip</a><span class="badge"><a class="color-inherit"
						href="releases/GererMaCampagne.1.0.0.zip" target="_blank">5c9e5f8ccb00e77ec18e4b24c4e5c435 <span
						class="glyphicon glyphicon-chevron-right"></span></a></span></li>
				<li class="list-group-item"><a href="releases/GererMaCampagne.0.9.9.tar.gz"
						target="_blank">GererMaCampagne.0.9.9.tar.gz</a><span class="badge"><a class="color-inherit"
						href="releases/GererMaCampagne.0.9.9.tar.gz" target="_blank">a086ab41354fb5e4051960f8012a9487 <span
						class="glyphicon glyphicon-chevron-right"></span></a></span></li>
				<li class="list-group-item"><a href="releases/GererMaCampagne.0.9.9.zip"
						target="_blank">GererMaCampagne.0.9.9.zip</a><span class="badge"><a class="color-inherit"
						href="releases/GererMaCampagne.0.9.9.zip" target="_blank">3307774bc0b4317b542c94e803d02875 <span
						class="glyphicon glyphicon-chevron-right"></span></a></span></li>
			</ul>
		</div>
	</div>
