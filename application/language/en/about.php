...
$lang["about_what_s_handlemycampaign_legend"] = "What is GererMaCampagne ?";
$lang["about_what_s_handlemycampaign_content"] = "GererMaCampagne is a web application allowing the proposal of a tweet for a
...
$lang["about_help_us_content"] = "GererMaCampagne is published by the 1901 law association <a href=\"https://www.armagnet.fr/\">ArmagNet</a>. You can help us by donations so that we can:
<ul>
...
$lang["about_need_help_content"] = "You want a clean install of GererMaCampagne in your infrastructure ?<br />
You need a specific feature that lacks GererMaCampagne ?<br />
<br />
No worries, <a href=\"#contactus\">contact us</a> to tell us about it and we will make you a custom quotatation.<br />
Indeed, GererMaCampagne is an application constantly evolving, but it may be
that your suggestion is a key feature that we would not have thought about (and that's also helping us).<br />
<br />
Be aware that the spirit in which GererMaCampagne is done is sharing, thus the features that will not be judged
