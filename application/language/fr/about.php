...
*/
$lang["about_what_s_handlemycampaign_legend"] = "Qu'est ce qu'GererMaCampagne ?";
$lang["about_what_s_handlemycampaign_content"] = "GererMaCampagne est une application web permettant la proposition de tweet pour
...
$lang["about_help_us_content"] = "GererMaCampagne est édité par l'association, de loi 1901, <a href=\"https://www.armagnet.fr/\">ArmagNet</a>. Vous pouvez
...
$lang["about_need_help_content"] = "Vous voulez une installation propre d'GererMaCampagne dans votre infrastructure ?<br />
Vous avez besoin d'une fonctionnalité précise qui manque à GererMaCampagne ?<br />
<br />
Pas de soucis, <a href=\"#contactus\">contactez-nous</a> pour nous en parler et au besoin
nous vous ferons un devis sur mesure.<br />
En effet, GererMaCampagne est une application en constante évolution mais il se peut que vous
nous proposiez une fonctionnalité clef à laquelle nous n'aurions pas pensé (et puis c'est aussi
nous aider).<br />
<br />
Sachez toutefois que l'esprit dans lequel GererMaCampagne est fait est le partage,
