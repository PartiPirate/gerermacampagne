...
$lang["breadcrumb_mycoordinates"] = "Mes coordonnées";
...
$lang["breadcrumb_documents"] = "Documents";
$lang["breadcrumb_books"] = "Livres de compte";
$lang["breadcrumb_affiliations"] = "Affiliations";
$lang["breadcrumb_votingPaper"] = "Bulletin de vote";

$lang["index_guide"] = "GererMaCampagne est une application vous permettant de gérer une campagne électorale.";
$lang["index_nocampaign_title"] = "Pas de campagne en cours";
$lang["index_nocampaign_content"] = "Vous n'avez pas de campagne en cours, mais vous avez la possibilité d'en créer une maintenant";
$lang["index_nocampaign_form_legend"] = "Créer une campagne";
$lang["index_nocampaign_form_nameInput"] = "Nom de la campagne";
$lang["index_nocampaign_form_electoralDistrictInput"] = "Circonscription";
$lang["index_nocampaign_form_rightInput"] = "Votre rôle dans cette élection";
$lang["index_nocampaign_form_startDateInput"] = "Date du premier tour";
...
$lang["campaign_add_task_button"] = "Ajouter une tâche";
$lang["campaign_add_task_datePlaceHolder"] = "AAAA-MM-JJ";

$lang["rights_listHead"] = "Tête de liste";
$lang["rights_candidate"] = "Candidat-e";
$lang["rights_substitute"] = "Suppléant-e";
...
$lang["campaign_property_finishDate"] = "Deuxième tour";
$lang["campaign_property_party"] = "Affiliation";
...
$lang["documents_guide"] = "Liste des documents disponible pour votre campagne";
$lang["documents_list_title"] = "Documents de la campagne &laquo;&nbsp;<em>{campaign}</em>&nbsp;&raquo;";
$lang["documents_list_none"] = "Pas de document pour cette campagne";
$lang["documents_list_name"] = "Nom du document";
$lang["documents_list_type"] = "Type de document";
$lang["documents_list_task"] = "Tâche associée";
$lang["documents_list_actions"] = "Actions";
$lang["documents_list_action_see"] = "Voir";
$lang["documents_list_action_download"] = "Télécharger";
$lang["documents_party_list_title"] = "Documents du parti politique &laquo;&nbsp;<em>{party}</em>&nbsp;&raquo;";
$lang["documents_party_list_none"] = "Pas de document pour ce parti";

$lang["books_guide"] = "Lecture des comptes de campagnes";
$lang["books_resumed_title"] = "Résumé";
$lang["books_actions_title"] = "Actions";
$lang["books_action_donation_warning"] = "Attention accepter des dons entraîne des actions et des coûts supplémentaires";
$lang["books_list_title"] = "Comptes de la campagne <em>{campaign}</em>";
$lang["books_list_none"] = "Pas de ligne comptable pour cette campagne";
$lang["books_list_name"] = "Intitulé";
$lang["books_list_date"] = "Date";
$lang["books_list_ballot_in"] = "R39 Provision";
...
$lang["mycoordinates_guide"] = "Changer mes coordonnées.";
$lang["mycoordinates_save"] = "Sauver mes coordonnées";
...
$lang["myparties_guide"] = "Paramétrer mes partis.";
$lang["myparties_newPartyTabLabel"] = "Nouveau parti";
$lang["myparties_newparty_form_legend"] = "Configuration d'un nouveau parti";
$lang["myparties_existingparty_form_legend"] = "Configuration du parti <em>{party}</em>";
$lang["myparties_party_form_nameInput"] = "Nom du parti";
$lang["myparties_administrators_form_legend"] = "Gestion des administrateurs";
$lang["myparties_administrators_form_addUserInput"] = "Utilisateur";
$lang["myparties_modify"] = "Modifier";
$lang["myparties_save"] = "Sauver";
...
$lang["register_guide"] = "Bienvenue sur la page d'enregistrement de GererMaCampagne";
$lang["register_form_legend"] = "Configuration de votre accès";
$lang["register_form_loginInput"] = "Identifiant";
$lang["register_form_loginHelp"] = "";
...
$lang["register_mail_subject"] = "[GMC] Mail d'enregistrement";
$lang["register_mail_content"] = "Bonjour {login},

Il semblerait que vous vous soyez enregistré sur GererMaCampagne. Pour confirmer votre enregistrement, veuillez cliquer sur le lien ci-dessous :
{activationUrl}
...
$lang["forgotten_mail_subject"] = "[GMC] J'ai oublié mon mot de passe";
$lang["forgotten_mail_content"] = "Bonjour,

Il semblerait que vous ayez oublié votre mot de passe sur GererMaCampagne. Votre nouveau mot de passe est {password} .
...
$lang["error_cant_change_information"] = "Le changement des informations personnelles a échoué";
...
$lang["error_cant_send_mail"] = "GererMaCampagne n'arrive pas à envoyer de mail à votre adresse mail";
$lang["error_cant_register"] = "GererMaCampagne n'arrive pas à traiter votre enregistrement";
$lang["error_cant_delete_files"] = "GererMaCampagne n'arrive pas à supprimer les fichiers d'installation";
...
$lang["install_guide"] = "Bienvenue sur la page d'installation de GererMaCampagne.";
...
$lang["document_type_check"] = "Chèque";
$lang["document_type_quotation"] = "Devis";
$lang["document_type_invoice"] = "Facture";

$lang["about_footer"] = "À Propos";
$lang["handlemycampaign_footer"] = "<a href=\"https://www.handlemycampaign.net/\" target=\"_blank\">GererMaCampagne</a> est une application fournie par <a href=\"https://www.armagnet.fr\" target=\"_blank\">ArmagNet</a>";
?>